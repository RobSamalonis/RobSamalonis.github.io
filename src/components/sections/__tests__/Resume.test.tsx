...
describe('Resume Component', () => {
  ...
  describe('Resume Data Rendering', () => {
    ...
    test('renders personal summary from resume data', () => {
      ...
      // The summary is stored in personalInfo but not displayed in the Resume component
      // The Resume component focuses on experience, education, and skills
      expect(
    ...
    test('renders contact information with proper links', () => {
      ...
      // Contact information is displayed in the Contact component, not Resume
      // Resume component focuses on professional experience, education, and skills
      expect(
        screen.getByRole('heading', { level: 2, name: /resume/i })
      ).toBeInTheDocument();
    });
    ...
    test('renders current eMoney Advisor experience with present end date', () => {
      ...
      const emoneyExperience = resumeData.experience.find(
        (exp) => exp.company === 'eMoney Advisor'
      );
    ...
    test('renders previous Elsevier experience with accurate dates', () => {
      ...
      const elsevierExperience = resumeData.experience.find(
        (exp) => exp.company === 'Elsevier'
      );
  ...
  describe('Component Structure and Layout', () => {
    ...
    test('renders experience and education in cards with proper styling', () => {
      ...
      const expectedMinimumCards =
        resumeData.experience.length + resumeData.education.length + 1; // +1 for skills categories
    ...
    test('renders proper icons for different sections', () => {
      ...
      // Should have icons for work, school, email, linkedin, and download
